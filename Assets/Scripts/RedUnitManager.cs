...
public class RedUnitManager : MonoBehaviour
{
    ...
    {
        // Attack check
        if (soldiers.Count > 0 && GameObject.FindWithTag("BlueArmy") != null)
        {
            UnitManager blueArmy = GameObject.FindWithTag("BlueArmy").GetComponent<UnitManager>();
            CheckForAttacks(blueArmy);
        }
